...
const AuthScreen = () => {
  ...
  return (
    ...
    <header className='max-w-6xl mx-auto flex items-center justify-between p-4'>
      ...
      py-1 px-2 rounded">Sign In</Link>
    </header>
    {/* hero section */}
    <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
      <h1 className='text-4xl md:text-6xl font-bold mb-4'>Unlimited movies, TV shows, and more</h1>
      <p className='text-lg mb-4'>Watch anywhere. Cancel anytime.</p>
      <p className='mb-4'>Readt to watch? Enter your email to create or restart your membership.</p>
      ...
      />
      <button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center'>Get Started
    ...
    <div className='py-10 bg-black text-white'>
     ...
     <div className='py-10 bg-black text-white'>
      ...
      <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
        {/* left side */}
        <div className='flex-1 text-center md:text-left'>
          <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Whatch everywhere</h2>
